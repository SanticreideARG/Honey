...
const Sucess = () => {
    return (
        <div className='container center-this pt-3'>
            <h2  className='center-this pt-3'>Gracias por tu compra!</h2>
            <p className='text-center pt-3'>Recibirás un correo electrónico a la brevedad para continuar con tu compra!</p>
